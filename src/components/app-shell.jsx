                        ...
                        <div className="flex flex-1 flex-col gap-4 overflow-y-auto">
                            ...
                            <footer className="mt-auto pt-8 pb-4 px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground/70">
                                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                                    ...
                                    <span>Designed & Built by <a href="https://github.com/ayushsolanki29" target="_blank" rel="noreferrer" className="font-medium hover:text-foreground hover:underline transition-colors">Ayush Solanki</a></span>
                                </div>
