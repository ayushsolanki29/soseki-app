...
router.post("/template-requests", authMiddleware, uploadMiddleware.single("file"), validate(organizationValidation.createTemplateRequestValidation), organizationController.createTemplateRequest);
